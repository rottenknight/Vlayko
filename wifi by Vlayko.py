...
FIGLET = '''\n
Donate if this work for you :) \nADA Adress: addr1qxrhsnfxp24tf6f4ft45cndnht9n4306mmgle8k9t8u8k94xel7mcekhrkzed20hju37cyd2axafakjz9e9wzjpqf24q65edq03
\n\n'''
...
if __name__ == '__main__':
    ...
    time.sleep(.5)
    print('\n Welcome to WiFi-Cracker (written by VlaYko)\n')
    time.sleep(1)
